...
def _select_collapsed_proof(page: Page) -> None:
    """Select the collapsed proof (click it) so its rail item becomes the shown
    one. Selection is click/focus-driven now, not scroll."""
